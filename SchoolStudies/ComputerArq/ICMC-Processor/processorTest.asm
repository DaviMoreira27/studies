...
;	4) Ja' terminou??? Cumpriu o que tinha que fazer??? O PC esta' pronto para a proxima instrucao (cuidado com Load, Loadn, Store, Jmp, Call)
	...
	add r3, r1, r2
	loadn r0, #10
	outchar r3, r0		; Printa F na linha 10 CHECK
	...
	sub r3, r1, r2
	loadn r0, #12
	outchar r3, r0		; Printa G na linha 12 CHECK
	...
	add r3, r4, r3
	loadn r0, #14
	outchar r3, r0		; Printa H na linha 14 CHECK
	...
	add r3, r4, r3
	loadn r0, #16
	outchar r3, r0		; Printa I na linha 16 CHECK 
	...
	dec r3
	dec r3
	outchar r3, r0		; Printa J na linha 18 CHECK
	...
	add r3, r4, r3
	loadn r0, #20
	outchar r3, r0		; Printa K na linha 20 CHECK
	...
	add r3, r4, r3
	loadn r0, #22
	outchar r3, r0		; Printa L na linha 22 CHECK
	...
	add r3, r4, r3
	loadn r0, #24
	outchar r3, r0		; Printa M na linha 24 CHECK
	...
	cmp r1, r2
	jgr Maior
	outchar r3, r0		; Printa O na linha 26 CHECK
	jmp SaiJMP
Maior:
	outchar r4, r0		; Printa N na linha 26 CHECK
	jmp SaiJMP
...
SaiJMP:
	...
	jmp CallSai
CallMaior:
	outchar r3, r0		; Printa O na linha 28 ERROR
	rts
CallMenorIgual:
	outchar r4, r0		; Printa X na linha 28 ERROR
	rts
...
CallSai:	
	...
	push r1
	pop r2
	outchar r2, r0		; Printa P na linha 30 CHECK
